...
class S {
  ...
  String get aiOverloaded =>
      _code == 'fr' ? 'L’IA est surchargée (503).' : 'AI is overloaded (503).';
  String requestFailedWithCode(int code) =>
      _code == 'fr' ? 'Échec de la requête ($code)' : 'Request failed ($code)';
  String get checkStatus =>
      _code == 'fr' ? 'Vérifier le statut' : 'Check status';
  String get grantPermissions =>
      _code == 'fr' ? 'Autoriser' : 'Grant permissions';
  String get hcGranted =>
      _code == 'fr' ? 'Autorisations accordées' : 'Permissions granted';
  String get hcDenied =>
      _code == 'fr' ? 'Autorisations refusées' : 'Permissions denied';
  String get hcWriteOk => _code == 'fr'
      ? 'Enregistré dans Health Connect'
      : 'Saved to Health Connect';
  String get hcWriteFail => _code == 'fr'
      ? "Échec de l’enregistrement dans Health Connect"
      : 'Failed to write to Health Connect';
  String get installHc =>
      _code == 'fr' ? 'Installer Health Connect' : 'Install Health Connect';
  String get updateHc =>
      _code == 'fr' ? 'Mettre à jour Health Connect' : 'Update Health Connect';
  String get settings => _code == 'fr' ? 'Paramètres' : 'Settings';
  String get systemLanguage =>
      _code == 'fr' ? 'Langue du système' : 'System language';
  ...
  String get daltonianMode =>
      _code == 'fr' ? 'Mode daltonien' : 'Colorblind-friendly mode';
  String get daltonianModeHint => _code == 'fr'
      ? 'Améliore les contrastes et couleurs pour les daltoniens'
      : 'Improves contrasts and colors for color vision deficiencies';
  ...
  String get describeMeal => _code == 'fr'
      ...
      : 'Provide details to help the AI';
  String get describeMealHint =>
      _code == 'fr' ? 'ex. poulet, riz, salade…' : 'e.g. chicken, rice, salad…';
  ...
  String get scanBarcode =>
      _code == 'fr' ? 'Scanner code-barres' : 'Scan barcode';
  String get sending => _code == 'fr' ? 'Envoi…' : 'Sending…';
  String get provideMsgOrImage => _code == 'fr'
      ? 'Veuillez fournir un message ou une image.'
      : 'Please provide a message or an image.';
  String get cameraNotSupported => _code == 'fr'
      ? 'La capture photo n’est pas prise en charge sur cette plateforme. Utilisez Choisir une image.'
      : 'Camera capture not supported on this platform. Use Pick Image instead.';
  String get failedOpenCamera =>
      _code == 'fr' ? 'Impossible d’ouvrir la caméra' : 'Failed to open camera';
  String get requestFailed =>
      _code == 'fr' ? 'Échec de la requête' : 'Request failed';
  String get error => _code == 'fr' ? 'Erreur' : 'Error';
  String get noHistory => _code == 'fr' ? 'Aucun historique' : 'No history yet';
  String get noDescription =>
      _code == 'fr' ? 'Sans description' : 'No description';
  String get weightLabel => _code == 'fr' ? 'Poids (g)' : 'Weight (g)';
  String get linkToWeight =>
      _code == 'fr' ? 'Lier les valeurs au poids' : 'Link values to weight';
  String get linkValues => _code == 'fr'
      ? 'Lier toutes les valeurs ensemble'
  ...
  // Burned energy + net
  String get burnedTodayTitle =>
      _code == 'fr' ? 'Calories brûlées aujourd’hui' : 'Calories burned today';
  String get refreshBurned => _code == 'fr' ? 'Rafraîchir' : 'Refresh';
  String get burnedLabel => _code == 'fr' ? 'Brûlées' : 'Burned';
  String get burnedNotAvailable => _code == 'fr'
      ? 'Données non disponibles (autorisez Health Connect)'
      : 'Data not available (grant Health permissions)';
  ...
  String get burnedHelp =>
      _code == 'fr' ? 'Calories brûlées et nettes' : 'Burned and net calories';
  ...
  String get copied =>
      _code == 'fr' ? 'Copié dans le presse‑papiers' : 'Copied to clipboard';
  ...
  String get editMeal =>
      _code == 'fr' ? 'Modifier' : 'Edit'; // from Edit meal to Edit
  ...
  String get deleteItem =>
      _code == 'fr' ? 'Supprimer l’élément' : 'Delete item';
  String get deleteConfirm => _code == 'fr'
  ...
  String get addManual =>
      _code == 'fr' ? 'Ajouter manuellement' : 'Add manually';
  String get addManuallyTitle =>
      _code == 'fr' ? 'Ajouter manuellement' : 'Add manually';
  String get mealBuilderActive => _code == 'fr'
      ? 'Construction d’un repas en cours'
      : 'Meal builder active';
  ...
  String get restoreDefaults =>
      _code == 'fr' ? 'Restaurer les valeurs par défaut' : 'Restore defaults';
  String get addAnotherQ => _code == 'fr'
      ? 'Ajouter un autre aliment à ce repas ?'
      : 'Add another item to this meal?';
  String get addAnother => _code == 'fr' ? 'Ajouter plus' : 'Add more';
  String get notNow => _code == 'fr' ? 'Pas maintenant' : 'Not now';
  String get mealStarted => _code == 'fr'
      ? 'Nouveau repas en cours. Ajoutez d’autres éléments.'
      : 'Meal started. Add more items.';
  ...
  String get packagedFood =>
      _code == 'fr' ? 'Produit emballé' : 'Packaged food';

  // Info menu
  String get info => _code == 'fr' ? 'Infos' : 'Info';
  String get about => _code == 'fr' ? 'À propos' : 'About';
  String versionBuild(String v, String b) =>
      _code == 'fr' ? 'Version $v ($b)' : 'Version $v ($b)';
  ...
  String get hideForever =>
      _code == 'fr' ? 'Masquer cette annonce' : 'Hide this announcement';
  String get disableAnnouncements =>
      _code == 'fr' ? 'Désactiver les annonces' : 'Disable announcements';
  ...
  // Queue & notifications
  String get queueAndNotifications => _code == 'fr'
      ? 'File d\'attente et notifications'
      : 'Queue & notifications';
  String get backgroundQueue =>
      _code == 'fr' ? 'File d\'attente en arrière-plan' : 'Background queue';
  String get processingQueue =>
      _code == 'fr' ? 'File en traitement' : 'Processing queue';
  String get queueEmpty => _code == 'fr' ? 'File vide' : 'Queue is empty';
  String get noPendingJobs =>
      _code == 'fr' ? 'Aucune tâche en attente' : 'No pending jobs';
  String get foodItem => _code == 'fr' ? 'Aliment' : 'Food item';
  String get totalNutrition =>
      _code == 'fr' ? 'Nutrition totale' : 'Total nutrition';
  String get notifications => _code == 'fr' ? 'Notifications' : 'Notifications';
  String get noNotificationsYet => _code == 'fr'
      ? 'Aucune notification pour l\'instant'
      : 'No notifications yet';
  String get statusPending => _code == 'fr' ? 'en attente' : 'pending';
  String get statusError => _code == 'fr' ? 'erreur' : 'error';
  String get queueInBackground =>
      _code == 'fr' ? 'Mettre en file d\'attente' : 'Queue in background';
  String get queueInBackgroundHint => _code == 'fr'
      ? 'Envoyer et continuer. Vous serez notifié quand c\'est prêt.'
      : 'Send and continue. Get notified when ready.';
  String queuedRequest(String id) => _code == 'fr'
      ? 'Requête mise en file d\'attente (#$id)'
      : 'Queued a request (#$id)';
  String get queuedWorking => _code == 'fr'
      ? 'En file d\'attente : traitement en arrière‑plan'
      : 'Queued: working in background';
  String get resultSaved => _code == 'fr'
      ? 'Résultat enregistré dans l\'historique'
      : 'Result saved to History';
  String get serviceUnavailable => _code == 'fr'
      ? 'Le service est indisponible, réessayez plus tard.'
      : 'Service is currently unavailable, please try again later.';

  // Food library
  String get foodLibrary =>
      _code == 'fr' ? 'Bibliothèque d’aliments' : 'Food library';
  ...
  String get saveCurrentMeal =>
      _code == 'fr' ? 'Ajouter le dernier repas' : 'Add the last meal';
  String get addCustomFood =>
      _code == 'fr' ? 'Ajouter un aliment personnalisé' : 'Add custom food';
  String get openLibrary =>
      _code == 'fr' ? 'Ouvrir la bibliothèque' : 'Open library';
  String get saveToLibrary =>
      _code == 'fr' ? 'Ajouter à la bibliothèque' : 'Save to library';
  ...
  String get productNotFound =>
      _code == 'fr' ? 'Produit non trouvé' : 'Product not found';
  String get quantityTitle =>
      _code == 'fr' ? 'Quantité (g/ml)' : 'Quantity (g/ml)';
  ...
  String get scanBarcodeTitle =>
      _code == 'fr' ? 'Scanner le code‑barres' : 'Scan barcode';
  String get barcodeNotAvailable => _code == 'fr'
      ? 'Le scan de code‑barres n’est pas disponible sur cette plateforme'
  ...
  String loginFailedCode(int c) =>
      _code == 'fr' ? 'Échec de connexion ($c)' : 'Login failed ($c)';
  String get loginError =>
      _code == 'fr' ? 'Erreur de connexion' : 'Login error';
  String get noTokenReceived =>
      _code == 'fr' ? 'Aucun jeton reçu' : 'No token received';
  String get networkError => _code == 'fr' ? 'Erreur réseau' : 'Network error';
  String get betaSignup => _code == 'fr'
      ? 'Pour participer à la bêta, demandez l\'accès.'
      : 'To sign up for this beta, please request access';
  String get joinDiscordAction =>
      _code == 'fr' ? 'Rejoindre le Discord' : 'Join our Discord';
  String get openDiscordFailed =>
      _code == 'fr' ? 'Impossible d\'ouvrir Discord' : 'Could not open Discord';
  String get logout => _code == 'fr' ? 'Se déconnecter' : 'Log out';

  // Set password
  String get setPasswordTitle =>
      _code == 'fr' ? 'Définir le mot de passe' : 'Set password';
  String get newPassword =>
      _code == 'fr' ? 'Nouveau mot de passe' : 'New password';
  String get confirmPassword =>
      _code == 'fr' ? 'Confirmer le mot de passe' : 'Confirm password';
  String get min6 => _code == 'fr' ? '6 caractères minimum' : 'Min 6 chars';
  String failedWithCode(int c) => _code == 'fr' ? 'Échec ($c)' : 'Failed ($c)';
  String get passwordsDoNotMatch => _code == 'fr'
      ? 'Les mots de passe ne correspondent pas'
      : 'Passwords do not match';

  // Export/Import
  String get exportHistory =>
      _code == 'fr' ? 'Exporter l\'historique' : 'Export history';
  String get importHistory =>
      _code == 'fr' ? 'Importer l\'historique' : 'Import history';
  String get exportCanceled =>
      _code == 'fr' ? 'Export annulé' : 'Export canceled';
  String get exportSuccess =>
      _code == 'fr' ? 'Historique exporté' : 'History exported';
  String get exportFailed =>
      _code == 'fr' ? 'Échec de l\'export' : 'Export failed';
  ...
  String get importSuccess =>
      _code == 'fr' ? 'Historique importé' : 'History imported';
  String get importFailed =>
      _code == 'fr' ? 'Échec de l\'import' : 'Import failed';
